...
export const ProgressCardSection = (props: Props) => {
  ...
  return (
    <div className="sm:bg-white max-w-full min-h-[211px] min-w-[320px] sm:min-w-[405px] max-h-[211px] h-full w-full flex flex-col rounded-16 pt-31 pb-20 justify-between sm:border sm:border-[#0B538D] sm:shadow-[0_0_15px_0_rgba(11,83,141,0.5)]">
      <RatingRow
        stars={5}
